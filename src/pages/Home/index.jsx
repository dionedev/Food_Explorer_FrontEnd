...
export function Home() {
  ...
  const cards = [
    ...
    { title: 'Salada', price: '35,10', imageUrl: imagePath, amount: 1 },
    { title: 'Salada', price: '20,10', imageUrl: imagePath, amount: 1 },
    { title: 'Salada', price: '10,10', imageUrl: imagePath, amount: 1 },
    { title: 'Salada', price: '10,10', imageUrl: imagePath, amount: 1 },
    { title: 'Salada', price: '10,10', imageUrl: imagePath, amount: 1 },
    { title: 'Salada', price: '10,10', imageUrl: imagePath, amount: 1 },
    { title: 'Salada', price: '10,10', imageUrl: imagePath, amount: 1 },
